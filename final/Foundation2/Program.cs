...
namespace Foundation2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            order2.AddProduct(new Product("Mouse", "TECH-015", 39.99, 1));
            order2.AddProduct(new Product("Gaming Headset", "TECH-025", 99.90, 1));
            order2.AddProduct(new Product("HDMI Cable", "TECH-088", 12.99, 5));
